...
The `calc_index.py <https://github.com/cerfacs-globc/icclim/blob/master/icclim/calc_index.py>`_ module contains basic routines for manipulating 3D arrays.
Below are some of them.

.. note:: A function name is composed of an index name and "_calculation" (example: FD_calculation).
