...
def vectorize(da, var_ds, indice_name, slice_mode=None):
    ...
    #TODO the metadata related the coords are here below. It has been commented because
    #of a bug. We should be able to build the dataset using the below lines.
    """, 
